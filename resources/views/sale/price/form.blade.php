...
@section('meta')
    <title>{{ __( 'Добавление цены' ) }} {{$sale->name}}</title>
@endsection
...
@section('content')
    ...
    <nav class="page-breadcrumb">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">
                <a href="{{route('sale.prices.index', ['sale' => $sale])}}">
                    {{ __( 'Цены' ) }}
                </a>
            </li>
            @if($model->id)
    ...
    <!-- form -->
    <form action="{{route('sale.prices.' . ($model->id ? 'update' : 'store'), ['sale' => $sale, 'price' => $model])}}" method="post" enctype="multipart/form-data">
    @csrf
            ...
            <div class="col-lg-4 grid-margin stretch-card">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('sale.prices.index', ['sale' => $sale]) }}" class="btn btn-primary">
                            {{ __( 'Отмена' ) }}
                        </a>
