    ...
    <div class="stretch-card">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!-- form -->
                <form action="{{ route('sale.index') }}" class="row">
                    @csrf
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($model as $item)
                            <tr>
                                ...
                                <td class="text-right">
                                    <a href="{{route('sale.edit', ['sale' => $item])}}" class="btn btn-info btn-xs">
                                        {{ __( 'Изменить' ) }}
                                    </a>
                                </td>
                                <td class="text-left">
                                    <form action="{{route('sale.destroy', ['sale' => $item])}}" method="post" onsubmit="return confirm('Вы уверены?')">
                                        @method('delete')
                                        @csrf
