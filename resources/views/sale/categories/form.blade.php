...
@section('content')
    ...
    <nav class="page-breadcrumb">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{route('sale.categories.index')}}">
                    {{ __( 'Категории' ) }}
                </a>
            </li>
            @if($model->id)
    ...
    <!-- form -->
    <form action="{{route('sale.categories.' . ($model->id ? 'update' : 'store'), ['category' => $model])}}" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-lg-4 grid-margin stretch-card">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('sale.categories.index') }}" class="btn btn-primary">
                            {{ __( 'Отмена' ) }}
                        </a>
