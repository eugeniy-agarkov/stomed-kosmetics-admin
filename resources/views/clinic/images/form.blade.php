...
@section('content')
    ...
    <nav class="page-breadcrumb">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('clinic.images.index', $clinic) }}">
                    {{ __( 'Галлерея' ) }}
                </a>
            </li>
    ...
    <!-- form -->
    <form action="{{route('clinic.images.' . ($model->id ? 'update' : 'store'), ['clinic' => $clinic, 'image' => $model])}}" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-lg-4 grid-margin stretch-card">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('clinic.images.index', $clinic) }}" class="btn btn-primary">
                            {{ __( 'Отмена' ) }}
                        </a>
