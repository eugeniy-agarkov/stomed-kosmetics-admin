...
@section('meta')
    <title>{{ __( 'SEO' ) }} {{$doctor->name}}</title>
@endsection
...
@section('content')
    ...
    <!-- form -->
    <form action="{{ route('doctor.page.store', $doctor) }}" method="post" enctype="multipart/form-data">
    @csrf
            ...
            <div class="col-lg-4 grid-margin stretch-card">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('doctor.edit', $doctor) }}" class="btn btn-primary">
                            {{ __( 'Отмена' ) }}
                        </a>
