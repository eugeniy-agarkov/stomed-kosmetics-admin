    ...
    <div class="stretch-card mt-0">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!-- btn -->
                <p>
                    <a href="{{route('direction.gallery.create', $direction)}}" class="btn btn-primary">
                        {{ __( 'Добавить' ) }}
                    </a>
                </p>
                <!-- end btn -->
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach($model as $item)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="{{route('direction.gallery.edit', ['direction' => $direction, 'image' => $item])}}" class="btn btn-info btn-xs">
                                            {{ __( 'Изменить' ) }}
                                        </a>
                                    </td>
                                    <td class="text-left">
                                        <form action="{{route('direction.gallery.destroy', ['direction' => $direction, 'image' => $item])}}" method="post" onsubmit="return confirm('Вы уверены?')">
                                            @method('delete')
                                            @csrf
